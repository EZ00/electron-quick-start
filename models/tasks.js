...
//   email: String
// });
var schema = require('./schemas/task.js');
var Model = require('../models/base');

var Task = new Model('tasks',schema);


Task.insert = function(done){
  var noop = function(){};
  done = done || noop;
...
Task.deleteById = function(_id,status,done){
  var noop = function(){};
  done = done || noop;
  var proto = Object.getPrototypeOf(this);
...
Task.updateOneById = function(id,newDoc,oldStatus,done){
  var noop = function(){};
  done = done || noop;
  var proto = Object.getPrototypeOf(this);
...
Task.updateOneByLocalId = function(id,newDoc,oldStatus,done){
  var noop = function(){};
  done = done || noop;
  var proto = Object.getPrototypeOf(this);
